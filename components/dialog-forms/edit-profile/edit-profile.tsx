...
import {handleEditProfileSubmit} from "@/components/dialog-forms/edit-profile/actions";
...
function EditProfile({user, hidden, isCurrentUser, children, size = "default"}: Props) {
    ...
    async function onSubmit(values: EditProfileFormData) {
        setLoading(true)
        await handleEditProfileSubmit(values, user)
        setLoading(false)
        setOpen(false)
    }
